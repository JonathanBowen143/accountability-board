...
Decision: Shift the next research lane away from Boston. Lowell / Rosario and Springfield / Hampden have both been tightened. Next priority order: Worcester County first because Cifizzari is strong but not Worcester-city-specific; Bristol / New Bedford-Dartmouth second because Tanner is DNA-testing/posthumous-relief posture, not yet exoneration-ready; Essex / Beverly remains a refresh lane while Carver's appeal posture remains live. Do not add Dana Gaul as a public node from this pass because the reviewed posture is wrongful arrest / dismissed charge rather than overturned murder conviction or final exoneration.
