...
Decision: Shift the next research lane away from Boston. Lowell / Rosario, Springfield / Hampden, and Worcester County / Cifizzari have been tightened. Next priority order: Bristol / New Bedford-Dartmouth first because Tanner is DNA-testing/posthumous-relief posture but not yet exoneration-ready; Essex / Beverly remains a refresh lane while Carver's appeal posture remains live; another Worcester County pass should wait for a distinct repeated actor or court-level source set rather than broad city filling. Do not add Dana Gaul as a public node from this pass because the reviewed posture is wrongful arrest / dismissed charge rather than overturned murder conviction or final exoneration.
