...
Current board state: Chemist Robert Pino is visible and connected narrowly to Michael J. Sullivan and Massachusetts State Police.

Decision: Keep Robert Pino visible but narrow. Do not add a separate State Police Crime Lab institution, Pinero connector, Mark Delaney, Carl Selavka, or other case links unless a future source-ledger pass opens that broader lane.
