...
Evidence: `WEB-SUFFOLK-FOXWORTH-KAMARA-LARKIN-FLYNN-2021-2023`; `WEB-GAINES-OMALLEY-OVERTURNED-MURDER-CONVICTION-2024-2025`; `docs/evidence/overturned-murder-conviction-mining.md`; `docs/evidence/murder-conviction-review-matrix.md`.
...
Decision: Keep the public board focused on repeated actor patterns and court/prosecution/police institutions. The matrix now separates graph-ready candidates from internal holds. James Lucien is the clearest next graph-ready candidate because the reviewed sources tie him to Suffolk/BPD and former Det. John Brazil, who is already on the board, but Lucien still needs a source-ledger entry before any visible graph change. Hold Stephen Pina, Daniel Pina, Edward Wright expansion, Thomas Rosa expansion, Rickey/FuQuan McGee, Michael Sullivan, James Carver, and Dewane Tse for additional actor-level or posture review before adding new visible nodes or edges. Existing Thomas Rosa and Edward Wright nodes can remain, but this pass did not add new public connectors for them.
