...
Current board state: Alan Jackson and David Yannetti each already connected to Karen Read as defense attorneys in the Read/O'Keefe criminal case. The first cleanup pass added a Jackson-to-Yannetti professional connector. The expanded pass adds existing-node courtroom and co-counsel connectors supported by public reporting. The called-witness cleanup adds Jackson/Yannetti case connectors to visible board nodes that appear in the project ledger as called witnesses in either Read criminal trial, adds Alessi case connectors to visible board nodes that appear as second-trial called witnesses, confirms Alessi's professional connectors to both Jackson and Yannetti, and connects all three defense attorneys to Judge Beverly Cannone. The prosecution-opposing-counsel cleanup adds Jackson, Yannetti, and Alessi case connectors to Hank Brennan, plus Jackson and Yannetti case connectors to Adam Lally. The Elizabeth Little pass adds Little as a visible defense-attorney node, connects her to the defense team, Cannone, Lally, Brennan, Karen Read, O'Keefe, the Birchmore discovery-motion lane, and gives her parity with Jackson/Yannetti for existing visible called-witness nodes because sources identify her as defense counsel in both trials. The prosecutor parity pass connects Lally to visible first-trial called-witness nodes, Brennan to visible second-trial called-witness nodes, and normalizes Jackson/Yannetti to the O'Keefe case anchor.

Decision: Keep the attorney-team connectors as `business/professional tie` edges, the courtroom/hearing/called-witness/opposing-counsel connectors as `case` edges, and the Little-to-Birchmore discovery-motion connector as a `filing` edge. These edges document public trial roles, called-witness status, hearing conflict, prosecution-defense structure, and defense-team structure; they do not imply private relationships or misconduct findings. Apply the same existing-node called-witness rule to Little that applies to Jackson and Yannetti because Little was part of both trials. Apply trial-scoped prosecutor parity: Lally receives first-trial visible called-witness connectors, and Brennan receives second-trial visible called-witness connectors. Do not add missing called witnesses as new public nodes from this rule alone. Witnesses who are not already visible should stay in `docs/karen-read-witness-ledger.md` unless a separate connector or public-accountability reason supports adding them. Keep Victoria George, Martin Weinberg, and other roster-only defense names internal unless a more specific public connector emerges.
...
### Root BWH / Fenwood Video, Security Interview, and BAPERN Media

Status: `ingested`, `source-note only`.

Evidence: `ROOT-BPD-DIT-VIDEO-CHRONOLOGY-2020`; `ROOT-BWH-SECURITY-THOMPSON-INTERVIEW-2020`; `ROOT-BPD-BAPERN-AUDIO-2020`; `ROOT-BROOKLINE-MAPPING-IMAGES-2020`; `ROOT-BPD-VIDEO-RECOVERY-TIMELINE-2020`.
...
Decision: Treat these sources as chronology, witness, radio-traffic, and orientation support. The BWH security witness should be named internally as William Thompson based on the recovered interview transcript, resolving the earlier Thomsen/Thomson slide-text conflict. Do not add Thompson, camera-location, Shapiro Building, map-image, or audio-file nodes unless a later scope decision makes one structurally necessary. The BAPERN transcript is machine-generated and must remain source-note-only until manual review; the Thompson audio also should not be used for direct quotes until manually reviewed.

## Priority Holds

### John Fanning / Root Public-Records Email

Status: `graph-ready for narrow Root interview-assignment expansion`.
...
Evidence: `ROOT-BUKHENIK-FANNING-IMAGE-2020`; `ROOT-BUKHENIK-CRAWFORD-FANNING-EMAIL-2020`; `ROOT-FANNING-SERT-EVIDENCE-SEARCH-2020`; `ROOT-NDAO-INTERVIEW-ASSIGNMENT-2020`; `_DRIVE_FULL_INDEX.tsv` lists `MSP- Yuri Bukhenik Brookline officers.png` and two indexed copies of `Tpr. Bukhenik Email Correspondence_redacted.pdf`.
...
Decision: The correspondence supports Bukhenik as a Root/Brookline communication, interview-handling, report/transcript-coordination, and evidence-search connector. The SERT email specifically says Bukhenik and DiCicco directed SERT to the Star Market search area. The NDAO interview-assignment email confirms Bukhenik's Brookline PD interview list, including Elcock and Wagner. The Elcock and Wagner connectors are case-handling links, not blame connectors. Do not use any of this correspondence as a misconduct source without a separate adjudicated or investigative record.

### David DiCicco

Status: `graph-ready for existing Root edge and Fanning assignment connector`.

Evidence: `ROOT-FANNING-SERT-EVIDENCE-SEARCH-2020`; `ROOT-NDAO-INTERVIEW-ASSIGNMENT-2020`; `_CAREER_INVENTORY_NorfolkCounty.md` says DiCicco overlaps Root, Read, and Walshe.

Current board state: DiCicco already has Root and Read spine edges, a Walshe edge, and a Fanning professional/report-assignment connector.

Decision: The recovered SERT email directly supports DiCicco's existing Root evidence-search role because it says Bukhenik and DiCicco directed SERT to the search area and were satisfied with the search results. The NDAO interview-assignment email separately identifies DiCicco's report-writing assignments, which supports the narrow Fanning-to-DiCicco professional connector. No broader DiCicco expansion is needed because the board already shows his Root spine edge and recurring MSP/Norfolk overlap lane.
...
### Echavarria / Lynn / Essex Wrongful-Conviction Lane

Status: `implemented`.

Evidence: `WEB-ECHAVARRIA-LYNN-ESSEX-WRONGFUL-CONVICTION-1994-2015`; `docs/evidence/murder-conviction-review-matrix.md`; `docs/evidence/overturned-murder-conviction-mining.md`.

Current board state: Angel Echavarria already appeared as a small gold-ring wrongful-conviction node. This pass adds direct institutional connectors to Lynn Police Department, Essex Superior Court, and Massachusetts State Police, adds Daniel Rodriguez as the underlying homicide-victim node, connects Rodriguez narrowly to Lynn Police and Essex DA, and connects Judge David Lowy to Essex Superior Court.

Decision: Keep this as a narrow Essex / Lynn institutional lane. Do not add John Garvin, Raymond Guillermo, John Hollow, City of Lynn, Mariano Bonifacio, Gary Sevinor, Isidoro Rodriguez, Juan Rodriguez / Raul Miranda, trial counsel, civil-rights counsel, or civil-case disposition actors without a later repeated-actor or civil-rights pattern pass.

### Choy / Plymouth / Brockton Wrongful-Conviction Lane

Status: `implemented`.

Evidence: `WEB-CHOY-PLYMOUTH-BROCKTON-WRONGFUL-CONVICTION-2003-2026`; `docs/evidence/murder-conviction-review-matrix.md`; `docs/evidence/overturned-murder-conviction-mining.md`.

Current board state: Frances Choy already appeared as a small gold-ring wrongful-conviction node connected to Plymouth County DA, John Bradley Jr., and Karen O'Sullivan. This pass adds Brockton Police Department, Plymouth Superior Court, Jimmy and Anne Choy as the compact underlying homicide-victim node, Massachusetts State Police and State Police Crime Laboratory connectors, Judge Linda Giles for the vacatur role, DA Timothy Cruz for the 2020 no-retrial/nolle posture, and O'Sullivan's Bristol County DA employment bridge from the recent disciplinary reporting.

Decision: Keep this as a narrow Plymouth / Brockton / State Police lab lane. Do not add Kenneth Choy, John Drugan, Richard Scott Warmington, Eric Clark, John Duggan, Michael Crisp, Frank Middleton Jr., Scott Berna, City of Brockton, Boston College Innocence Program counsel, bar counsel, BBO members, Bristol DA Thomas Quinn, or settlement actors without a later repeated-actor, disciplinary, lab, or civil-rights pattern pass.

### Waters / Maher / Ayer / Middlesex DNA-Exoneration Lane

Status: `implemented`.

Evidence: `WEB-WATERS-MAHER-AYER-MIDDLESEX-DNA-EXONERATION-1980-2025`; `docs/evidence/murder-conviction-review-matrix.md`; `docs/evidence/overturned-murder-conviction-mining.md`.

Current board state: Kenneth Waters already appeared as a small gold-ring wrongful-conviction node. This pass adds Katharina Reitz Brow as the compact underlying homicide-victim node, connects Waters to Ayer Police Department, Middlesex DA, Middlesex Superior Court, and Brow, and connects Brow to Ayer Police and Middlesex DA. Dennis Maher now carries the non-murder repeated-actor connector to Ayer Police, Lowell Police, Middlesex Superior Court, and the State Police Crime Laboratory.

Decision: Keep this as a narrow Ayer / Middlesex wrongful-conviction and repeated-actor pocket. Maher is relevant to the public board because Ayer, Taylor-Harris, Middlesex court/prosecution, Lowell, and lab evidence recur, but he should not be described as an overturned murder-conviction row. Joseph Leo Boudreau is documented internally as the 2025 cold-case identification in the Brow murder, but he should not be a visible node unless the board opens a dedicated cold-case resolution layer.
