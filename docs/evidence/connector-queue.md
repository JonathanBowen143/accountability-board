...
Evidence: `WEB-SUFFOLK-FOXWORTH-KAMARA-LARKIN-FLYNN-2021-2023`; `WEB-GAINES-OMALLEY-OVERTURNED-MURDER-CONVICTION-2024-2025`; `WEB-LUCIEN-BRAZIL-SUFFOLK-BPD-2021-2024`; `docs/evidence/overturned-murder-conviction-mining.md`; `docs/evidence/murder-conviction-review-matrix.md`.

Current board state: Robert Foxworth, Barry Kamara, Raymond Gaines, and James Lucien are represented as small exonerated/wrongful-conviction nodes, not large victim anchors. Foxworth and Kamara connect to Suffolk DA, Boston Police, Suffolk Superior Court, former Suffolk ADA James Larkin, and former Boston Sgt. Det. Daniel Flynn. Gaines connects narrowly to Suffolk DA, Boston Police, Suffolk Superior Court, and the existing Det. Peter O'Malley node. Lucien connects narrowly to Suffolk DA, Boston Police, Suffolk Superior Court, and the existing Det. John Brazil node.

Decision: Keep the public board focused on repeated actor patterns and court/prosecution/police institutions. The matrix now separates visible small-node additions from internal holds. Hold Stephen Pina, Daniel Pina, Edward Wright expansion, Thomas Rosa expansion, Rickey/FuQuan McGee, Michael Sullivan, James Carver, and Dewane Tse for additional actor-level or posture review before adding new visible nodes or edges. Existing Thomas Rosa and Edward Wright nodes can remain, but this pass did not add new public connectors for them. The next research pass should test either the Judge Michael Ricciuti Rosa/McGee pattern or the Peter O'Malley cluster using court-level sources.
